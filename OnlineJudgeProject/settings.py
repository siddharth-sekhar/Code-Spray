...
SECRET_KEY = 'django-insecure-a07w#mz#4hpugqtmi(_hj(pejvv(%53ztt6ovpc)xgnp_7wwz5'
...
MIDDLEWARE = [
    ...
    'users.views.PreventBackButtonMiddleware',  # Custom middleware for preventing back button access
]
